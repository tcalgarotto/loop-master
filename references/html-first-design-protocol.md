...
> Complementa: `gsap-premium-protocol.md` (motion no HTML) · `design-system-intake.md` (referências) · `lucy-nova-pagina-protocol.md` (port para React) · **`design-editable-hybrid-protocol.md`** (Caminho C: HTML → Penpot → Next)
