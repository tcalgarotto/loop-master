...
|------|----------------------|
| Animação / perf UI | `html-native-light-protocol.md`, `gsap-premium-protocol.md`, **`premium-motion-scroll-protocol.md`**, **`learned/gsap-plugin-orchestration.md`** |
...
| MCP / integrações / quiz setup | `mcp-integrations-setup-guide.md`, `claude-mem-nvidia-setup.md`, `learned/claude-mem-mcp-operational-playbook.md` |
...
| Processo / orquestração premium | `premium-tool-orchestration.md`, **`learned/proactive-orchestration-mandate.md`** |
