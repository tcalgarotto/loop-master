...
|------|------|--------|-------------------|
| 2026-07-03 | `browser-ai-scrape` | Pipeline browser→screenshot+markdown→LLM/vision; Firecrawl Sandbox, Obscura, Playwright | `references/browser-ai-scrape-protocol.md` |
