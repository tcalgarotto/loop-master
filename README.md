...
<div align="center">
  ...
  <p>
    <a href="SKILL.md"><img src="https://img.shields.io/badge/version-2.9.15-blueviolet" alt="version"></a>
...
/lucy visual-gate                    → Screenshots Playwright + vision QA (gate FE)
/lucy visual-gate --escopo /crm
/lucy visual-gate --capture-only     → Só PNGs; julgar depois no Cursor
```
...
| `references/html-first-design-protocol.md` | HTML-first: preview local antes de Next |
...
**v2.9.15** — claude-mem L2 com NVIDIA build.nvidia.com + guia multi-sessão. Ver [CHANGELOG.md](CHANGELOG.md).
